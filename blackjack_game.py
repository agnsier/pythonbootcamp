...
chip = 100 # Could also make this a raw input.
...
#     money = raw_input('Enter number of money you have:')
# def choose_first():
#     if random.randint(0, 1) == 0:
#         return 'Dealer starts'
#     else:
#         return 'You starts'
...
def make_bet():
    ...
    while bet == 0:
        ...
        if bet_comp >= 1 and bet_comp <= chip:
            bet = bet_comp
        else:
            print "Invalid bet, you only have " + str(chip) + " remaining"
...
def deal_cards():
    ...
    global result, playing, deck, player_hand, dealer_hand, chip, bet
    ...
    result = raw_input("Hit or Stand? Press either h or s: ")
...
def hit():
    ...
    global playing, chip, deck, player_hand, dealer_hand, result, bet
